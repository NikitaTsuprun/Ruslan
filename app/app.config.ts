...
export default defineAppConfig({
  ...
  legal: {
    status: 'Самозанятый', // или 'ИП'
    fullName: 'Ганеев Руслан', // ФИО оператора перс. данных (лучше полностью, с отчеством)
    inn: '', // ИНН — обязателен для Директа. Впишите цифры, напр. '772233445566'
