...
type Bank = 'tbank' | 'ozon' | 'sber' | 'cb'
type CaseType = '115' | '161' | 'kompromet'
...
// Чтобы добавить новый кейс — положите изображение в public/cases/
// и добавьте объект в этот массив (img, bank, type, title, text).
const cases: CaseItem[] = [
  {
    img: '/cases/cb-161-apr.jpg',
    bank: 'cb',
    type: '161',
    title: 'ЦБ РФ: исключение из базы по 161-ФЗ',
    text: 'Официальный ответ Банка России — сведения о клиенте отсутствуют в базе данных о переводах без согласия. Апрель 2026.',
  },
  {
    img: '/cases/tbank-schet.jpg',
    bank: 'tbank',
    type: '115',
    title: 'Т-Банк: ограничения по счёту сняты',
    text: 'После подготовки документов и пояснений банк завершил проверку и снял все ограничения по счёту.',
  },
  {
    img: '/cases/ozon-161.jpg',
    bank: 'ozon',
    type: '161',
    title: 'Ozon Банк: данные исключены из базы ЦБ',
    text: 'Реквизиты клиента исключены из списка Банка России по 161-ФЗ — счёт снова работает в обычном режиме.',
  },
  {
    img: '/cases/sber-115.jpg',
    bank: 'sber',
    type: 'kompromet',
    title: 'Сбербанк: все ограничения сняты',
    text: 'Банк рассмотрел обращение и снял ограничения на открытие счёта, выпуск и перевыпуск карт.',
  },
  {
    img: '/cases/cb-161-mar.jpg',
    bank: 'cb',
    type: '161',
    title: 'ЦБ РФ: подтверждено отсутствие в базе',
    text: 'Банк России подтвердил, что ограничения по 161-ФЗ к клиенту не применяются. Март 2026.',
  },
  {
    img: '/cases/ozon-115.jpg',
    bank: 'ozon',
    type: '115',
    title: 'Ozon Банк: счёт разблокирован',
    text: 'Банк снял ограничения — клиент снова пользуется счётом и картой Ozon без ограничений.',
  },
  {
    img: '/cases/sber-karta.jpg',
    bank: 'sber',
    type: '115',
    title: 'Сбербанк: карта перевыпущена',
    text: 'Доступ восстановлен — Сбербанк перевыпустил карту, операции и деньги снова доступны клиенту.',
  },
]

// Логотипы банков — SVG-файлы в public/logos/
const bankLogo: Record<Bank, string> = {
...
const typeName: Record<CaseType, string> = {
  '115': '115-ФЗ',
  '161': '161-ФЗ',
  kompromet: 'Компрометация',
}

const bankChips: { id: 'all' | Bank; label: string }[] = [
